 ...
 * @constructor
 */
TaskHintIcon = function(block, content) {
 ...
 * @private
 */
TaskHintIcon.prototype.createEditor_ = function() {
 ...
 * @private
 */
TaskHintIcon.prototype.resizeBubble_ = function() {
...
TaskHintIcon.prototype.getText = function() {
  return this.textarea_ ? this.textarea_.innerHTML : this.text_;
};
