...
Abbozza.Parse = {
    ...
    init: function () {
        ...
        this.setColour(ColorMgr.getColor("cat.PARSE"));
...
Abbozza.ParseCmdDecl = {
    init: function () {
        this.setHelpUrl(Abbozza.HELP_URL);
        this.setColour(ColorMgr.getCatColor("cat.PARSE"));
        thisBlock = this;
        this.appendDummyInput()
                .appendField(_("parse.CMD"))
...
Blockly.Blocks['parse_parse'] = Abbozza.Parse;
Blockly.Blocks['parse_cmd_control'] = Abbozza.ParseCmdControl;
Blockly.Blocks['parse_cmd_decl'] = Abbozza.ParseCmdDecl;
...
Blockly.Blocks['parse_response'] = Abbozza.ParseResponse;
