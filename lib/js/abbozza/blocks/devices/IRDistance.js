...
Abbozza.DeviceIRDist = {
    ...
    init: function () {
        ...
        this.appendDummyInput()
                .appendField(_("dev.DEVICE") + ": " + _("dev.IRDIST"))
    ...
    decompose: function (workspace) {
        var topBlock = Blockly.Block.obtain(workspace, "dev_ir_read_formula");
...
Abbozza.DeviceIRReadFormula = {
    ...
    setValues: function (type, a, b, c) {
        this.getField_("TYPE").setValue(type);
        this.getField_("A").setText(new String(a));
        this.getField_("B").setText(new String(b));
        this.getField_("C").setText(new String(c));
    },
