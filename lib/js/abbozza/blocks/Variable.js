...
Abbozza.VariableNum = {
    init: function () {
        ...
        this.setColour(Abbozza.VAR_COLOR);
        thisBlock = this;
...
Abbozza.VariableBlock = {
    ...
    init: function () {
        ...
        this.setColour(Abbozza.VAR_COLOR);
        // thisBlock = this;
        this.inp = this.appendDummyInput()
                .appendField(new VariableDropdown(this, function (name) {
                    ...
                    this.sourceBlock_.changeOutput([this.symbol[1], "VAR" + this.symbol[1], "VAR"]);
                }), "NAME");
    ...
    domToMutation: function (xmlElement) {
        ...
        if (this.symbol) {
            this.changeOutput([this.symbol[1], "VAR" + this.symbol[1], "VAR"]);
            // this.changeOutput([this.symbol[1], "VAR"]);
        }
    },
    getSymbol: function () {
        if (this.symbol != null) {
...
Blockly.Blocks['devices_block'] = Abbozza.VariableNum;
