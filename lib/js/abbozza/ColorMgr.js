...
ColorMgr.catColor["cat.FUNC"]=310;
ColorMgr.catColor["cat.VAR"]=345;
ColorMgr.catColor["cat.LOGIC"]=210;
ColorMgr.catColor["cat.MATH"]=230;
ColorMgr.catColor["cat.TEXT"]=160;
ColorMgr.catColor["cat.COND"]=210;
ColorMgr.catColor["cat.LOOPS"]=120;
ColorMgr.catColor["cat.INOUT"]=80;
ColorMgr.catColor["cat.DEVICES"]=270;
ColorMgr.catColor["cat.SERIAL"]=100;
ColorMgr.catColor["cat.DEVIN"]=120;
ColorMgr.catColor["cat.DEVOUT"]=140;

ColorMgr.typeColor = new Array();

ColorMgr.typeColor["BOOLEAN"]=210; //blue
ColorMgr.typeColor["NUMBER"]=120;  //green
ColorMgr.typeColor["DECIMAL"]=80;  //alt.green
ColorMgr.typeColor["STRING"]=40;    //brown
ColorMgr.typeColor["DEVICE"]=270;  //blue
ColorMgr.typeColor["VAR"]=345;
ColorMgr.typeColor["FUNC"]=310;
ColorMgr.typeColor["PIN"]=230;
