...
Abbozza.DisplayShowInternalImage = {
    ...
    generateCode : function(generator) {
        var code = "calliope.display.print(MicroBitImage(" + this.getFieldValue("IMAGE") +"),0)";
        return code;
    }
}
...
Abbozza.DisplayImage = {
    init : function() {
        ...
        this.setPreviousStatement(false);
        this.setNextStatement(false);
        this.appendDummyInput().appendField(_("block.image"));
        ...
        this.setOutput("true",["STRING","IMAGE"]);
        this.setTooltip('');
    },
        ...
        for (row=0; row <5; row++) {
            for (col=0; col < 5; col++) {
                ...
                switch (value) {
                    ...
                    case "#400000": image = image+"30"; break;
                    case "#580000": image = image+"60"; break;
                    case "#700000": image = image+"90"; break;
                    case "#880000": image = image+"120"; break;
                    case "#a00000": image = image+"150"; break;
                    case "#b80000": image = image+"180"; break;
                    case "#d00000": image = image+"210"; break;
                    case "#e80000": image = image+"230"; break;
                    case "#ff0000": image = image+"255"; break;
                }
                if (col<4) image = image + ",";
            }
