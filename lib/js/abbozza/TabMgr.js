...
Blockly.Connection.prototype.highlight = function() {
  ...
  // console.log("Blockly.Connection.prototype.highlight: hacked version"); 
  ...
  if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
    ...
    var type ="";
    if ( this.check_) type = this.check_[0];
...
Blockly.BlockSvg.prototype.renderDrawLeft_ =
  ...
  // console.log("Blockly.BlockSvg.prototype.renderDrawLeft_: hacked version"); 
    ...
    if (this.RTL) {
      ...
      highlightSteps.push('l', (Blockly.BlockSvg.TAB_WIDTH * -0.45) + ',-2.1');
    	...
    	switch (type) {
    		...
    		case "NUMBER" 	:
      			highlightSteps.push('V', Blockly.BlockSvg.TAB_HEIGHT+1);
      			highlightSteps.push('m -6,-8 c 0,-6 2,-7.5 6,-7.5 l 0,-4');
    			break;
    		case "DECIMAL" 	:
      			highlightSteps.push('V', Blockly.BlockSvg.TAB_HEIGHT-1);
      			highlightSteps.push('m -8,0 l 0,-15 8,0 0,-3');
    			break;
    		case "BOOLEAN" 	:
      			highlightSteps.push('V', Blockly.BlockSvg.TAB_HEIGHT - 1);
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(steps, highlightSteps,
  ...
  // console.log("Blockly.BlockSvg.prototype.renderDrawRight_: hacked version"); 
...
//          }
      ...
      this.renderFields_(input.fieldRow, fieldX, fieldY);
          ...
          var type = "";
          if (input.connection &&  input.connection.check_ ) type = input.connection.check_[0];
          var tab;
...
//          }
      ...
      connectionY = connectionsXY.y + cursorY;
      if (input.connection) input.connection.moveTo(connectionX, connectionY);
