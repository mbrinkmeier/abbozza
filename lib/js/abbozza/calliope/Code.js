...
AbbozzaCode['cond_if'] = [ 'if (#):#', [ "V_CONDITION" , "S_STATEMENTS"] ];
AbbozzaCode['cond_if_else'] = [ 'if (#):#else:#', [ "V_CONDITION" , "S_STATEMENTS1" , "S_STATEMENTS2" ] ];

AbbozzaCode['loop_endless'] = ["while True:#",["S_STATEMENTS"]];
AbbozzaCode['loop_while'] = ["while (#):#",["V_CONDITION","S_STATEMENTS"]];
AbbozzaCode['loop_fixed'] = ["for __counter in range(#):#",["V_COUNT","S_STATEMENTS"]];
AbbozzaCode['loop_count'] = ["for # in range(#, #, #):#",["F_VAR","V_FROM","V_TO","V_STEP","S_STATEMENTS"]];
...
AbbozzaCode['math_random'] = ["random.randrange(0,#)",["V_MAX"]];
AbbozzaCode['math_random2'] = ["random.randint(#,#)",["V_MIN","V_MAX"]];
AbbozzaCode['math_randomseed'] = ["random.seed(#)",["V_SEED"]];
