...
AbbozzaGenerator.prototype.workspaceToCode = function(opt_workspace) {
  ...
  if ( Configuration.getParameter("option.use_long") == "true" ) {
      __keywords["NUMBER"] = "long";
  } else {
      __keywords["NUMBER"] = "int";
  }
  
  // Check if doubles should be used
  if ( Configuration.getParameter("option.use_double") == "true" ) {
      __keywords["DECIMAL"] = "double";
  } else {
      __keywords["DECIMAL"] = "float";
  }
...
AbbozzaGenerator.prototype.enforceType = function(code,enfType) {
	switch(enfType) {
		...
		case "TEXT":
		case "STRING":
			code = "String(" + __keywords["NUMBER"] + "(" + code +"))";
			break;
		case "DECIMAL":
			code = "" + __keywords["DECIMAL"] + "(" + code +")";
			break;
		case "BBOLEAN":
			code = "boolean(" + __keywords["NUMBER"] + "(" + code +") != 0 )";
			break;
	}	
        return code;
}
