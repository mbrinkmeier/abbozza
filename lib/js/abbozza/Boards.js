...
Board.init = function () {
    ...
    Connection.getXMLSynced("/js/abbozza/boards.xml",
            function (xml) {
                Board.boardsXML = xml;
            },
            function (xml) {
...
/*
 ...
 var BoardUno = new Board();
 BoardUno.shortDesc 	 = "Arduino UNO";
 BoardUno.description = "Arduino UNO and compatible";
 BoardUno.analogIn 	 = 6;
 BoardUno.analogOut 	 = 0;
 BoardUno.digitalPins = 14;
 BoardUno.pwm 	     = [3, 5, 6, 9, 10, 11];
 BoardUno.internalLED = 13;
 BoardUno.interrupts  = [3,2];
 BoardUno.serialRX	 = 0;
 BoardUno.serialTX	 = 1;
 
 var BoardLeonardo = new Board();
 BoardLeonardo.shortDesc   = "Arduino Leonardo";
 BoardLeonardo.description = "Arduino Leonardo and compatible";
 BoardLeonardo.analogIn 	  = 12;
 BoardLeonardo.analogOut   = 0;
 BoardLeonardo.digitalPins = 20;
 BoardLeonardo.pwm 	      = [ 3, 5, 6, 9, 10, 11, 13 ];
 BoardLeonardo.internalLED = 13;
 BoardLeonardo.interrupts  = [3,2,0,1,7];
 BoardLeonardo.serialRX	  = 0;
 BoardLeonardo.serialTX	  = 1;
