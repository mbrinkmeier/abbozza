...
var Abbozza = {
    ...
    /* CTRL_COLOR: ColorMgr.getColor("cat.CTRL"),
    ...
    DEVOUT_COLOR: ColorMgr.getCatColor("cat.DEVOUT"),
    DEVIN_COLOR: ColorMgr.getCatColor("cat.DEVIN"),
    SERIAL_COLOR: ColorMgr.getCatColor("cat.SERIAL"), */
...
Abbozza.init = function () {
    ...
    if ( window.location.search != "") {
        ...
        Connection.getXML(sketchPath,
            ...
            function(responde) {
                alert(sketchPath + " not found or no valid sketch!");
                Abbozza.newSketch();
            }
        );
    } else {
