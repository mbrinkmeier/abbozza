...
Abbozza.newSketch = function () {
    ...
    TaskOverlay.setContent("",true);
    TaskOverlay.setSize(600,400);
    // Abbozza.taskContent = "";
...
Abbozza.setSketch = function (sketch) {
    ...
    if (task[0]) {
        TaskOverlay.setContent(task[0].textContent,true);
        TaskOverlay.setSize(task[0].getAttribute("width"),task[0].getAttribute("height"));
...
Abbozza.saveSketch = function () {
    ...
    task.textContent = TaskOverlay.getContent(); // Abbozza.taskContent;
    task.setAttribute("width",TaskOverlay.getWidth());
    task.setAttribute("height",TaskOverlay.getHeight());
...
Abbozza.openTaskOverlay = function() {
    // if ( this.taskOverlay.isVisible() ) {
    //     this.taskOverlay.hide();        
    // } else {
    if ( !TaskOverlay.isVisible() ) {
        // TaskOverlay.setContent(Abbozza.taskContent);
    }
