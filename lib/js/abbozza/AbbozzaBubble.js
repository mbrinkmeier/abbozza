...
AbbozzaBubble = function(workspace, content, shape, classname,
  ...
  if (content == null) {
      ...
      AbbozzaBubble.superClass_.constructor.call(this, workspace, this.createSvg_(), this.svgPath_, new goog.math.Coordinate(anchorX, anchorY), bubbleWidth, bubbleHeight);
  } else {
      AbbozzaBubble.superClass_.constructor.call(this, workspace, content, shape, new goog.math.Coordinate(anchorX, anchorY), bubbleWidth, bubbleHeight);
  }
...
AbbozzaBubble.prototype.layoutBubble_ = function() {
    ...
    this.textarea_.setAttribute("title",size.width + "x" + size.height);    
}

AbbozzaBubble.prototype.positionBubble_ = function() {
  var left;
  if (this.workspace_.RTL) {
    left = this.anchorXY_.x - this.relativeLeft_ - this.width_;
  } else {
    left = this.anchorXY_.x + this.relativeLeft_;
  }
