...
AbbozzaBubble = function(workspace, content, shape, classname, anchorXY,
  ...
  if (content == null) {
      ...
      AbbozzaBubble.superClass_.constructor.call(this, workspace, content, shape, anchorXY, bubbleWidth, bubbleHeight);
  }
...
AbbozzaBubble.prototype.createSvg_ = function() {
  ...
  */
  ...
  this.body_.className = 'blocklyMinimalBody';
...
AbbozzaBubble.prototype.resize_ = function() {
  ...
  this.body_.style.width = (size.width-10) + 'px';
  this.body_.style.height = (size.height-10) + 'px';
